...
public class PacketTileEntityData implements IMessage {
    ...
    public static <UTileEntity extends TileEntity & PartialUpdateHandler> PacketTileEntityData packetEntityData(
        UTileEntity entity, String context, Object... params) {
