...
package ivorius.psychedelicraft.internal.bezier;
...
public class IvBezierPath3DCreator {
    ...
    public static IvBezierPath3D createSpiraledBezierPath(double distCenter, double heightDistInf, double spirals,
        double maxHeight, double fontSize, double heightFontInf, boolean staged) {
        ...
        for (double height = 0; height <= maxHeight; height += maxHeight / spirals) {
            ...
            bezierPoints.add(
                new IvBezierPoint3D(
                    new double[] { distance0, height0, -distance0 },
                    new double[] { -0.5 * distance0, 0.0, -0.5 * distance0 },
                    0xffffffff,
                    0.0,
                    fontSize + height0 / maxHeight * heightFontInf));
            if (height1 <= maxHeight) {
                bezierPoints.add(
                    new IvBezierPoint3D(
                        new double[] { -distance1, height1, -distance1 },
                        new double[] { -0.5 * distance1, 0.0, 0.5 * distance1 },
                        0xffffffff,
                        0.0,
                        fontSize + height1 / maxHeight * heightFontInf));
            }
            if (height2 <= maxHeight) {
                bezierPoints.add(
                    new IvBezierPoint3D(
                        new double[] { -distance2, height2, distance2 },
                        new double[] { 0.5 * distance2, 0.0, 0.5 * distance2 },
                        0xffffffff,
                        0.0,
                        fontSize + height2 / maxHeight * heightFontInf));
            }
            if (height3 <= maxHeight) {
                bezierPoints.add(
                    new IvBezierPoint3D(
                        new double[] { distance3, height3, distance3 },
                        new double[] { 0.5 * distance3, 0.0, -0.5 * distance3 },
                        0xffffffff,
                        0.0,
                        fontSize + height3 / maxHeight * heightFontInf));
            }
        }
    ...
    public static IvBezierPath3D createSpiraledBezierPath(double distCenter, double heightDistInf, double spirals,
        double[] endPos, double fontSize, double heightFontInf, boolean staged) {
        ArrayList<IvBezierPoint3D> bezierPoints = new ArrayList<>();
        ...
        for (double height = 0; height <= endPos[1]; height += endPos[1] / spirals) {
            ...
            bezierPoints.add(
                new IvBezierPoint3D(
                    new double[] { distance0 + x0, height0, -distance0 + z0 },
                    new double[] { -0.5 * distance0, 0.0, -0.5 * distance0 },
                    0xffffffff,
                    0.0,
                    fontSize + height0 / endPos[1] * heightFontInf));
            if (height1 <= endPos[1]) {
                bezierPoints.add(
                    new IvBezierPoint3D(
                        new double[] { -distance1 + x1, height1, -distance1 + z1 },
                        new double[] { -0.5 * distance1, 0.0, 0.5 * distance1 },
                        0xffffffff,
                        0.0,
                        fontSize + height1 / endPos[1] * heightFontInf));
            }
            if (height2 <= endPos[1]) {
                bezierPoints.add(
                    new IvBezierPoint3D(
                        new double[] { -distance2 + x2, height2, distance2 + z2 },
                        new double[] { 0.5 * distance2, 0.0, 0.5 * distance2 },
                        0xffffffff,
                        0.0,
                        fontSize + height2 / endPos[1] * heightFontInf));
            }
            if (height3 <= endPos[1]) {
                bezierPoints.add(
                    new IvBezierPoint3D(
                        new double[] { distance3 + x3, height3, distance3 + z3 },
                        new double[] { 0.5 * distance3, 0.0, -0.5 * distance3 },
                        0xffffffff,
                        0.0,
                        fontSize + height3 / endPos[1] * heightFontInf));
            }
        }
    ...
    public static IvBezierPath3D createSpiraledSphere(double radius, double spirals, double fontSize) {
        ...
        for (double height = 0; height <= radius; height += radius / spirals) {
            ...
            bezierPoints.add(
                new IvBezierPoint3D(
                    new double[] { distance0, height0 + centerYShift, -distance0 },
                    new double[] { -0.5 * distance0, 0.0, -0.5 * distance0 },
                    0xffffffff,
                    0.0,
                    fontSize));
            if (height1 <= radius) {
                bezierPoints.add(
                    new IvBezierPoint3D(
                        new double[] { -distance1, height1 + centerYShift, -distance1 },
                        new double[] { -0.5 * distance1, 0.0, 0.5 * distance1 },
                        0xffffffff,
                        0.0,
                        fontSize));
            ...
            if (height2 <= radius) {
                bezierPoints.add(
                    new IvBezierPoint3D(
                        new double[] { -distance2, height2 + centerYShift, distance2 },
                        new double[] { 0.5 * distance2, 0.0, 0.5 * distance2 },
                        0xffffffff,
                        0.0,
                        fontSize));
            ...
            if (height3 <= radius) {
                bezierPoints.add(
                    new IvBezierPoint3D(
                        new double[] { distance3, height3 + centerYShift, distance3 },
                        new double[] { 0.5 * distance3, 0.0, -0.5 * distance3 },
                        0xffffffff,
                        0.0,
                        fontSize));
