...
public class IvBezierPoint3DCachedStep {
    ...
    public IvBezierPoint3DCachedStep(IvBezierPoint3D leftPoint, int leftPointIndex, IvBezierPoint3D rightPoint,
        int rightPointIndex, double leftPointProgress, double rightPointProgress, double innerProgress) {
    ...
    public double[] getPosition() {
        if (cachedPosition == null) {
            ...
            cachedPosition = IvVecMathHelper
                .cubicMix(leftPoint.position, bezierFrom, bezierTo, rightPoint.position, getInnerProgress());
        }
