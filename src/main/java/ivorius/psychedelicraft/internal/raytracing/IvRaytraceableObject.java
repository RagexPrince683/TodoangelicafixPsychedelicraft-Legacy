...
public abstract class IvRaytraceableObject {
     ...
     */
    public void addIntersectionsForLineToList(List<IvRaytracedIntersection> list, double x, double y, double z,
     ...
     * @param zDir The x-value of the vector direction
     */
    public abstract void addRaytracedIntersectionsForLineToList(List<IvRaytracedIntersection> list, double x, double y,
        double z, double xDir, double yDir, double zDir);

    public double[][] getRaytracedIntersectionsForLine(double x, double y, double z, double xDir, double yDir,
        double zDir) {
        ArrayList<IvRaytracedIntersection> intersections = new ArrayList<>();
        addRaytracedIntersectionsForLineToList(intersections, x, y, z, xDir, yDir, zDir);
        ...
        for (int i = 0; i < intersections.size(); i++) {
            intersectionPoints[i] = intersections.get(i)
                .getPoint();
        }
    ...
    public IvRaytracedIntersection getFirstHitPointForLine(double x, double y, double z, double xDir, double yDir,
        double zDir) {
        ArrayList<IvRaytracedIntersection> intersections = new ArrayList<>();
        addRaytracedIntersectionsForLineToList(intersections, x, y, z, xDir, yDir, zDir);
