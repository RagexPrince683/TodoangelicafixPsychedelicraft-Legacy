...
public class IvVecMathHelper {
    ...
    public static double lengthSQ(double[] vector) {
        ...
        for (double aValue : vector) max += aValue * aValue;
    ...
    public static double lengthSQ(int[] vector) {
        ...
        for (int aValue : vector) max += aValue * aValue;
    ...
    public static double lengthSQ(long[] vector) {
        ...
        for (long aValue : vector) max += aValue * aValue;
    ...
    public static int[] add(int[]... vectors) {
        ...
        for (int d = 0; d < result.length; d++) for (int v = 1; v < vectors.length; v++) result[d] += vectors[v][d];
    ...
    public static int[] sub(int[] vector, int[]... subVectors) {
        ...
        for (int i = 0; i < result.length; i++) for (int[] subVector : subVectors) result[i] -= subVector[i];
    ...
    public static double[] sub(double[] vector, double[]... subVectors) {
        ...
        for (int i = 0; i < result.length; i++) for (double[] subVector : subVectors) result[i] -= subVector[i];
